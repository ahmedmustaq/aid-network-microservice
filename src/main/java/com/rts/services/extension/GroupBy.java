 ...
 */
public class GroupBy<T> extends PathSpecification<T> implements WithoutTypeConversion {

	private static final long serialVersionUID = 1L;
	
	private String groupBy = "";

    public GroupBy(QueryContext queryContext, String path, String... args) {
    ...
    public Predicate toPredicate(Root<T> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
       ...
       return query.groupBy(root.get(groupBy)).getGroupRestriction();
    }
